...
INSERT INTO `user` (`user_id`, `user_account`, `password`, `user_name`, `user_email`, `user_address`, `user_introduce`, `role`) VALUES
(1, 'admin', 'admin', '管理员', '32', '火星', '', 1),
(13, 'zhang', '123', '张三', '20', '木星', '', 2),
(17, '頁碼', '123456', '頁碼', '1', '1', '', NULL),
(20, 'kimn1', '123', '123', '11', 'person 測試', '', NULL);
