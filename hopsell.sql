...
(3, 3, 'U型枕（U型按摩枕）NT$300', 2, ' @twitter', 'https://media.karousell.com/media/photos/profiles/2015/12/12/jayhaa_1449886293.jpg', 5, '值得推薦的好賣家！', NULL, '2021-08-25 22:33:39');
...
(1, 12, '時尚衣裝', 860, 1, NULL, '已完成', '2021-08-28 20:19:07', '2021-08-29 20:18:05'),
(5, 10, '時尚衣裝', 860, 1, NULL, '已完成', '2021-08-31 14:38:33', NULL),
(6, 6, '娛樂休閒', 500, 1, NULL, '已完成', '2021-08-31 18:40:47', NULL);
...
(1, 'admin', 'admin', 'https://media.karousell.com/media/photos/profiles/2020/04/04/mianhuuu_1585929644.jpg', '管理员', 'kim.pierce@example.com', '中彰投', '', '2021-08-01 14:41:58', '2021-09-01 23:20:09', 1),
...
(22, 'kimn', '123456', 'https://randomuser.me/api/portraits/men/47.jpg', NULL, 'a9523023650@gmail.com', '中彰投', NULL, '2021-09-01 04:02:07', '2021-09-03 00:42:51', 2);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '商品_主鍵', AUTO_INCREMENT=20;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=24;
COMMIT;
